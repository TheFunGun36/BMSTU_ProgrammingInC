...
START_TEST(test_sorted_merge_insert)
{
    int list1[] = {1, 2, 3, 9, 10};
    int list2[] = {4, 5, 6, 7, 8};
...
START_TEST(test_sorted_merge_insert2)
{
    int list1[] = {4, 5, 6, 7, 8};
    int list2[] = {1, 2, 3, 9, 10};
...
Suite *main_suite(void)
{
    ...
    tcase_add_test(tc2, test_sorted_merge_insert);
    tcase_add_test(tc2, test_sorted_merge_insert2);
